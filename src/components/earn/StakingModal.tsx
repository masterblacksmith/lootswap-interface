...
import { TokenAmount, Pair } from '@lootswap/sdk'
              ...
              <BlueCard>
                <AutoColumn gap="10px">
                  <TYPE.link fontWeight={400} color={'primaryText1'}>
                    <b>Important:</b> There&apos;s <b>no deposit fee</b> when depositing funds to the liquidity farming
                    pools.
                    <br />
                    <br />
      ...
      {attempting && hash && !failed && (
        <SubmittedView onDismiss={wrappedOnDismiss} hash={hash}>
          <AutoColumn gap="12px" justify={'center'}>
            ...
            <TYPE.body fontSize={20}>Deposited {parsedAmount?.toSignificant(4)} LOOT-LP</TYPE.body>
          </AutoColumn>
        </SubmittedView>
      )}
      {!attempting && !hash && failed && (
