...
export const ROUTER_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.HARMONY_MAINNET]: '0x6d9eF21E7b93CF0C45847d586E1b9eFCaaB76009',
...
export const MASTER_LOOTER: { [chainId in ChainId]: string } = {
  ...
  [ChainId.BSC_MAINNET]: ZERO_ONE_ADDRESS,
  [ChainId.BSC_TESTNET]: ZERO_ONE_ADDRESS,
  [ChainId.HARMONY_MAINNET]: '0xb96618aEBD36f8D83Fa03873FdA796264597604D',
  [ChainId.HARMONY_TESTNET]: ZERO_ONE_ADDRESS
}
...
export const AUTO_LOOTER: { [chainId in ChainId]: string } = {
  ...
  [ChainId.BSC_MAINNET]: ZERO_ONE_ADDRESS,
  [ChainId.BSC_TESTNET]: ZERO_ONE_ADDRESS,
  [ChainId.HARMONY_MAINNET]: '0x8d9CfA003b9DAc566e11A4722bB28Ba306af0aeC',
  [ChainId.HARMONY_TESTNET]: ZERO_ONE_ADDRESS
}
