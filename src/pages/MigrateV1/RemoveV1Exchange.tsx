...
import { JSBI, Token, TokenAmount, WETH, Fraction, Percent, CurrencyAmount } from '@lootswap/sdk'
  ...
  const liquidityToken: Token | undefined = useMemo(
    () =>
      validatedAddress && chainId && token
        ? new Token(chainId, validatedAddress, 18, `UNI-V1-${token.symbol}`, 'Lootswap V1')
        : undefined,
    ...
    <BodyWrapper style={{ padding: 24 }} id="remove-v1-exchange">
      <AutoColumn gap="16px">
        <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
          ...
          <div>
            <QuestionHelper text="Remove your Lootswap V1 liquidity tokens." />
          </div>
        </AutoRow>
